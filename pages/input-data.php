...
// $sql1=sqlsrv_query($conn,"select partnername from partners where id='");	
// $r1=sqlsrv_fetch_array($sql1,SQLSRV_FETCH_ASSOC);
// $sql2=sqlsrv_query($conn,"select partnername from partners where id='");	
// $r2=sqlsrv_fetch_array($sql2,SQLSRV_FETCH_ASSOC);
...
// 		pcjo.PCID = '$r[PCID]'
// group by ko.KONo");
// 					$rKO=sqlsrv_fetch_array($ko,SQLSRV_FETCH_ASSOC);
